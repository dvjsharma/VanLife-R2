...
createServer({
    ...
    seeds(server) {
        ...
        server.create("user", { id: "456", email: "dvj@vanlife.com", password: "123", name: "Divij" })
        server.create("user", { id: "123", email: "shiv@vanlife.com", password: "123", name: "Shivkant" })
        server.create("user", { id: "789", email: "ukraj@vanlife.com", password: "123", name: "Utkarsh" })
    },
